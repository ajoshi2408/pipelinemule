...
---
{
	...
	errorMessage: "Contract's data for Contract: " ++ contractNum ++ " and Amendment: " ++ amendmentNum ++ " not updated in C-Sight due to following error - " ++ vars.errorMessage ++ " | " ++ errorDescription,
	errorDescription: (errorDescription default "Failed to update Contract in C-Sight.") ++ " Contract: " ++ contractNum ++ " and Amendment: " ++ amendmentNum,
